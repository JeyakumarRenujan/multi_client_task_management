...
export const WorkloadDistribution: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-primary-400/70 dark:border-primary-500/35 shadow-sm flex flex-col justify-between transition-shadow">
      <div>
