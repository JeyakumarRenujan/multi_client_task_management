    ...
    <div
      ...
      className={`p-4 sm:p-5 rounded-2xl border transition-all duration-300 flex flex-col justify-between cursor-pointer group ${
        isArchived
          ...
          : 'bg-white dark:bg-slate-900 border-slate-200/80 dark:border-slate-800/80 shadow-sm hover:shadow-md hover:border-emerald-400 dark:hover:border-emerald-600'
      }`}
    >
      <div>
        {/* Card Header */}
