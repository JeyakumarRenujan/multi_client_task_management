...
export const IdleScreensaver: React.FC = () => {
  ...
  const getThemePalette = (accent: string) => {
    switch (accent) {
      case 'rose':
        return {
          bg: 'bg-gradient-to-br from-[#3b0d24]/95 via-[#4d1230]/90 to-[#3b0d24]/95',
          glow1: 'bg-pink-400/20',
          glow2: 'bg-pink-300/18',
          glowCenter: 'bg-[#db2777]/20',
          textPrimary: 'text-pink-100',
          textAccent: 'text-pink-300',
          textSecondary: 'text-pink-200/80',
          badgeBg: 'bg-pink-950/60 border-pink-400/30 text-pink-200',
          borderAccent: 'border-pink-400/30',
          ring1: 'border-pink-400/25 shadow-[0_0_80px_rgba(236,72,153,0.25)]',
          ring2: 'border-pink-300/30',
          ringFill: 'from-pink-400/15 via-pink-300/10 to-transparent',
          ledColor: 'text-pink-300 drop-shadow-[0_0_40px_rgba(236,72,153,0.6)]',
          barGradient: 'from-pink-500 via-pink-400 to-pink-300 shadow-[0_0_12px_rgba(236,72,153,0.9)]',
          serifGradient: 'from-white via-pink-100 to-pink-200 drop-shadow-[0_0_40px_rgba(236,72,153,0.5)]',
          orbitBorder: 'border-pink-300/30',
